      ...
      <div style={{ position: 'relative', zIndex: 10, maxWidth: '1250px', width: '100%', padding: '60px 40px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: '1', minWidth: '320px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
            <SkillBox title="Programação & Dev" items={["Python & APIs", "React & Next.js", "Tailwind CSS", "MongoDB"]} />
            <SkillBox title="Dados & Ferramentas" items={["Power BI & Dashboards", "Excel Avançado", "Jira & Trello", "Lucidchart"]} />
            <SkillBox title="Infra & Cloud" items={["Vercel & Render", "Supabase", "Cisco Packet Tracer", "Automação de Tarefas"]} />
            <SkillBox title="Engenharia & IA" items={["Scrum (Sprints/PO)", "Arquitetura de Sistemas", "Chatbots (OpenAI/Gemini)", "Full Stack Integration"]} />
          </div>
        </div>
