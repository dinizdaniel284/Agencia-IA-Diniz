...
role: 'assistant',
content:
'Olá! Eu sou o agente de IA do Daniel. Posso ajudar a criar automações, sistemas ou integrações para sua empresa.'
}
])
...
return `Posso automatizar tarefas da sua empresa como:
...
return `Daniel desenvolve sistemas web completos:
...
Seu sistema seria para qual área?`
}

if (t.includes('api') || t.includes('integra')) {
return `Integrações são uma das especialidades.
...
Qual sistema você quer integrar?`
}
...
Posso mostrar exemplos aplicados ao seu negócio.`
}

return `Interessante. Me conte um pouco mais do que você precisa.

Se preferir podemos falar direto no WhatsApp:
https://wa.me/5519992278928`
}
